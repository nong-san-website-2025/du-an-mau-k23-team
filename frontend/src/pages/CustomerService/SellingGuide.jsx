      ...
      <main style={{ background: "#ffffff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <Typography.Title level={2} style={{ color: "#237804" }}>
              Hướng Dẫn Đăng Ký Bán Hàng Trên GreenFarm
            </Typography.Title>
            <Typography.Paragraph type="secondary" style={{ fontSize: 16, maxWidth: 700, margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center", marginTop: 32 }}>
            <Typography.Text type="secondary" style={{ fontSize: 14 }}>
              ...
              <a href="mailto:support@greenfarm.vn">support@greenfarm.vn</a> hoặc hotline{" "}
              <Typography.Text strong>0123 456 789</Typography.Text>.
            </Typography.Text>
          </div>
        </div>
      </main>
