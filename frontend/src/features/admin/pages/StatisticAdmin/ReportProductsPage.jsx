...
export default function ReportProductsPage() {
  ...
  const topColumns = [
    ...
    },
    {
      ...
      align: "center",
      render: (value) => (
        <Tag color={value <= 10 ? "warning" : "success"}>{value}</Tag>
      ),
    },
    // {
    //   title: "Thao tác",
  ...
  const lowStockColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Tooltip
          title={record.stock === 0 ? "Nhập khẩn cấp" : "Tạo phiếu nhập"}
        >
          <Button
            icon={<DollarOutlined />}
            size="small"
  ...
  const lowStockTabs = [
    {
      ...
      children: (
        <Table
          ...
          size="small"
          locale={{
            emptyText: <Empty description="Không có sản phẩm sắp hết" />,
          }}
        />
      ),
    },
    {
      ...
      children: (
        <Table
          ...
          size="small"
          locale={{
            emptyText: <Empty description="Tốt! Không có sản phẩm hết hàng" />,
          }}
        />
      ),
    },
