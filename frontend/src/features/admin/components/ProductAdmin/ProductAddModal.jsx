...
const ProductAddModal = ({ open, onClose, onSuccess }) => {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="pam-modal-overlay d-flex align-items-center justify-content-center"
          initial="hidden"
          animate="visible"
          exit="exit"
                ...
                <div className="col-12 col-lg-6">
                  ...
                  <div className="d-flex gap-3 mt-3">
                    <div className="form-check">
                      <input className="form-check-input" type="checkbox" id="is_new" name="is_new" checked={form.is_new} onChange={handleChange} />
                      <label htmlFor="is_new" className="form-check-label">Hàng mới</label>
                    </div>
                    <div className="form-check">
                      <input className="form-check-input" type="checkbox" id="is_organic" name="is_organic" checked={form.is_organic} onChange={handleChange} />
                      <label htmlFor="is_organic" className="form-check-label">Hữu cơ</label>
                    </div>
                    <div className="form-check">
                      <input className="form-check-input" type="checkbox" id="is_best_seller" name="is_best_seller" checked={form.is_best_seller} onChange={handleChange} />
                      <label htmlFor="is_best_seller" className="form-check-label">Bán chạy</label>
                    </div>
                  </div>
                </div>
              </div>
