...
export default function Footer() {
  ...
  return (
    <footer className="bg-light border-top mt-5 pt-5 pb-0" style={{ fontSize: 15 }}>
      <div className="container px-4 px-md-5">
        {/* --- 4 CỘT CHÍNH --- */}
        <div className="row gy-4 text-start text-md-start mb-4">
          {/* Cột 1 - Dịch vụ khách hàng */}
          <div className="col-12 col-md-3 px-2">
            <h6 className="fw-bold mb-3 text-uppercase text-dark" style={{ letterSpacing: 1 }}>
              Dịch vụ khách hàng
            </h6>
          ...
          <div className="col-12 col-md-3 px-2">
            ...
            <ul className="list-unstyled mb-3">
              ...
              <li className="d-flex align-items-center mb-2">
                ...
                <a href="mailto:info@greenfarm.vn" className={linkClass}>info@greenfarm.vn</a>
              </li>
              <li className="d-flex align-items-center mb-2">
          ...
          <div className="col-12 col-md-3 px-2">
            ...
            <div className="d-flex flex-wrap justify-content-start align-items-stretch gap-4">
              <div className="d-flex flex-column align-items-center">
                <span className="fw-bold footer-title mb-2 text-dark" style={{ fontSize: 15 }}>
                  Thanh toán
                </span>
                <img
        ...
        <div className="row align-items-center mt-3 mb-4">
          <div className="col-12 col-md-6 text-md-start text-center">
            <div className="d-flex align-items-center justify-content-md-start justify-content-center gap-3">
              <img src={logo} alt="GreenFarm" width={100} className="rounded" />
              <p className="text-muted mb-0" style={{ lineHeight: 1.6, maxWidth: 350 }}>
                GreenFarm là nền tảng cung cấp nông sản sạch, an toàn và chất lượng cao
                cho mọi gia đình Việt Nam. Hành trình xanh – vì sức khỏe cộng đồng 🌱
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-4 mb-3">
          <div className="d-flex align-items-center justify-content-center mb-2 text-dark fw-semibold">
            ...
            Địa chỉ: Khu vực Thạnh Thắng, phường Phú Thứ, quận Cái Răng, TP. Cần Thơ
          </div>
          <div
            className="rounded overflow-hidden shadow-sm border mx-auto"
            style={{ width: "100%", height: 180, maxWidth: 650 }}
          >
            <iframe
        ...
        <div className="border-top mt-4 pt-3 text-center">
          ...
          >
            ...
            <span style={{ color: "#14532d" }}>GreenFarm.vn</span> – Nông sản sạch cho mọi nhà 🌿
          </p>
        </div>
      </div>
