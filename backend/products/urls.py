...
from reviews.serializers import ReviewListCreateView
...
urlpatterns = [
    ...
    path("<int:product_id>/reviews/", ReviewListCreateView.as_view(), name="product-reviews"),  # Cho phép truy cập chi tiết sản phẩm qua /api/products/<id>/
]
