    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('deposit', 'Nạp tiền'), ('withdraw', 'Rút tiền'), ('sale_income', 'Doanh thu bán hàng'), ('refund_deduct', 'Trừ tiền hoàn hàng'), ('platform_fee', 'Phí sàn')], max_length=20)),
